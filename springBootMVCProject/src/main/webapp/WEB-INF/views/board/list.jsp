...
<body>
   <c:set var="path" value="${pageContext.request.contextPath}"/> <!--변수지정해서 src 편하게 쓰려고  -->
	<span><h1>✿ʕ•ﻌ•ʔ 게 시 목 록 ʕ•ﻌ•ʔ✿</h1></span>
	<br>
	<h2 align="center">
	<a href="insert">[̲̅$̲̅(̲̅ ͡° ͜ʖ ͡°̲̅)̲̅$̲̅]     <!-- http://localhost:9090/myapp/webboard/insert 누르면 이렇게 이동 -->
	...
	<table class="table  table-striped table-bordered table-hover ">
		...
		<c:forEach items="${blist.result.content }" var="board"
			...
			<tr>
				...
				<td><a href="detail?bno=${board.bno}">${board.bno }</a>
